...
int threshold = 35;                 // Minimum signal from the piezo to register as a knock. Higher = less sensitive. Typical values 1 - 10
...
void doorUnlock(int delayTime){
  chirp(75, 1500);                  // And play a tone in case the user can't see the LED.
  chirp(100, 1200);
  chirp(75, 1500);  
  digitalWrite(ledPin, HIGH);
